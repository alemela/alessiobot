...
path = '/data/project/alessiobot/data/categorizzare_template/'+today+'.txt'
template = u'<noinclude>{{Categorizzare|template}}</noinclude>'
comment = u'Bot: template non categorizzato'
